 ...
 * @author jimzhang
 * @version V1.0.0
 * @description  将一张图切分到不到页面拼起来
 * @home <>https://segmentfault.com/u/itzhangjm</>
 * @date 2017-11-10 14:13
 */
public class C06E02_TheGoldenGateBridge_Tiles {
    public static final String SRC = "src/main/resources/static/pdf/the_golden_gate_bridge.pdf";
    ...
    public void createPdf(String src, String dest) throws IOException {
        ...
        AffineTransform transformationMatrix = AffineTransform.getScaleInstance(tileSize.getWidth() / orig.getWidth() * 2f,
