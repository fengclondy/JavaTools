 ...
 * @author jimzhang
 * @version V1.0.0
 * @description Simple event handler example  简单的事件处理程序示例
 * @home <>https://segmentfault.com/u/itzhangjm</>
 * @date 2017-11-09 16:18
 */
public class C03E03_UFO {
    ...
    protected void createPdf(String dest) throws Exception {
        ...
        // 将一个事件处理程序MyEventHandler添加到PdfDocument，在每次pdf文档的事件发生时触发。END_PAGE发生。这就是说:
        // 每次iText都将内容添加到页面中，要么是因为创建了一个新页面，要么是因为已经完成了最后一页。
