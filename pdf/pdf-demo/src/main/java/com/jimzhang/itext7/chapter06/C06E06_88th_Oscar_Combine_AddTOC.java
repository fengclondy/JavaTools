 ...
 * @author jimzhang
 * @version V1.0.0
 * @description  基于内容表的合并,选取特定内容并合并
 * @home <>https://segmentfault.com/u/itzhangjm</>
 * @date 2017-11-10 14:16
 */
public class C06E06_88th_Oscar_Combine_AddTOC {
    public static final String SRC1 = "src/main/resources/static/pdf/88th_noms_announcement.pdf";
    public static final String SRC2 = "src/main/resources/static/pdf/oscars_movies_checklist_2016.pdf";
