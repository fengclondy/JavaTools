...
/**
 * Created by jimzhang on 2017/9/18.
 */
...
//        File fin = new File("E:\\temp\\20170917\\20170917.txt");//读取的文件
//        File fout = new File("E:\\temp\\20170917\\20160622_627975_1.txt");//写出的文件
...
//        }
        ...
        FileChannel fcout = new RandomAccessFile(fout1, "rws").getChannel();
        ...
        writeFileByLine(fcout, wBuffer, string);
